...
class MyDataSet:
    def __init__(self, node_feature, edge_index, batch, y_entity, y_sentiment, all_sentiment):
        self.x = node_feature
    ...
    def data_embedding(self):
        ...
        for i in range(len(self.x)):
            ...
            data = Data(node_feature=x_i, edge_index=edge_index_i, batch=batch_i, y_entity=y_entity_i, y_sentiment=y_sentiment_i, all_sentiment=all_sentiment_i)
